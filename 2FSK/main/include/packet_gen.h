...
#include <stdbool.h>
#include <stdbool.h>
#define LONG_RANGE_MODE 0 // 0 - no encoding; 1 - convolutional encoding with spreading;
#define REED_SOLOMON 0//0 - no Reed Solomon ; 1 - implent Reed Solomon
// #define PAYLOADTYPE 0 // 0 for constant payload and 1 for pseudo-random payload
